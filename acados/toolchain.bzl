...
def _acados_toolchain_impl(ctx):
...
acados_toolchain = rule(
    implementation = _acados_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a acados compiler/runtime toolchain.
