...
# By default all these toolchains are registered by the acados_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:acados_toolchain",
    toolchain_type = "@com_wito1_rules_acados//acados:toolchain_type",
)
""".format(
            platform = platform,
